        ...
        for(int v=0;v<ct-1-1;v++)
        {
            ...
            for(i=0;i<127;i++)
            {
                for(j=0;j<127;j++)
                {
                    ...
                    rgb=vhd[v].data[i][j]/255.0;        glColor3f(rgb,rgb,rgb);   glVertex3f(x0,y0,z0);
                    rgb=vhd[v].data[i][j+1]/255.0;      glColor3f(rgb,rgb,rgb);   glVertex3f(x0,y1,z0);
                    rgb=vhd[v+1].data[i][j+1]/255.0;    glColor3f(rgb,rgb,rgb);   glVertex3f(x0,y1,z1);
                    rgb=vhd[v+1].data[i][j]/255.0;      glColor3f(rgb,rgb,rgb);   glVertex3f(x0,y0,z1);
                    //3
                    rgb=vhd[v+1].data[i][j]/255.0;      glColor3f(rgb,rgb,rgb);   glVertex3f(x0,y0,z1);
                    rgb=vhd[v+1].data[i+1][j]/255.0;    glColor3f(rgb,rgb,rgb);   glVertex3f(x1,y0,z1);
                    rgb=vhd[v+1].data[i+1][j+1]/255.0;  glColor3f(rgb,rgb,rgb);   glVertex3f(x1,y1,z1);
                    rgb=vhd[v+1].data[i][j+1]/255.0;    glColor3f(rgb,rgb,rgb);   glVertex3f(x0,y1,z1);
                    //4
                    rgb=vhd[v].data[i+1][j]/255.0;        glColor3f(rgb,rgb,rgb);   glVertex3f(x1,y0,z0);
                    rgb=vhd[v].data[i+1][j+1]/255.0;      glColor3f(rgb,rgb,rgb);   glVertex3f(x1,y1,z0);
